...
This project involves the Udaicty Term 2 Simulator which can be downloaded [here](https://github.com/udacity/self-driving-car-sim/releases)
...
![Build Steps](./misc/build_instructions.png)
...
## Sample Project Ouput

Dataset 1

![Dataset 1](./misc/dataset_one.gif)

Dataset 2

![Dataset 2](./misc/dataset_two.gif)
